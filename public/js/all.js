...
},{"../numeral":6}],7:[function(require,module,exports){
'use strict';

var serverHost = 'http://upgi.ddns.net'; // production
...
(0, _jquery2.default)('document').ready(function () {
    (0, _jquery2.default)('#currentDate').text((0, _momentTimezone2.default)((0, _momentTimezone2.default)(), 'YYYY-MM-DD HH:mm:ss').format('YYYY-MM-DD'));

    _jquery2.default.getJSON(_config2.default.serverUrl + '/overdueMonitor/overview').done(function (overviewData) {
        (0, _jquery2.default)('td#AMTN_PENDING_SUMMARY').text((0, _numeral2.default)(overviewData[0].AMTN_PENDING).format('$0,0'));
        (0, _jquery2.default)('td#AMTN_OVERDUE_SUMMARY').text((0, _numeral2.default)(overviewData[0].AMTN_OVERDUE).format('$0,0'));
        (0, _jquery2.default)('td#AMTN_DEPOSIT_SUMMARY').text((0, _numeral2.default)(overviewData[0].AMTN_DEPOSIT).format('$0,0'));
    }).fail(function (error) {
        alert(error);
    });
    _jquery2.default.getJSON(_config2.default.serverUrl + '/overdueMonitor/annualReportSummary').done(function (annualReportSummaryDataList) {
        annualReportSummaryDataList.forEach(function (annualReportSummaryData) {
            (0, _jquery2.default)('tbody#annualReportSummary').append('<tr>\n                    <td class="text-center">' + annualReportSummaryData.YEAR + '</td>\n                    <td class="text-center">' + (0, _numeral2.default)(annualReportSummaryData.AMTN_OVERDUE).format('$0,0') + '</td>\n                    <td class="text-center danger">' + (0, _numeral2.default)(annualReportSummaryData.AMTN_PENDING).format('$0,0') + '</td>\n                    </tr>');
        });
    }).fail(function (error) {
        alert(error);
    });
    _jquery2.default.getJSON(_config2.default.serverUrl + '/overdueMonitor/warning_OneWeek').done(function (warning_OneWeekDataList) {
        warning_OneWeekDataList.forEach(function (warning_OneWeekData) {
            (0, _jquery2.default)('ol#oneWeekWarningList').append('<li class="panel panel-success">\n                        <div class="panel-heading">\n                            <strong>' + warning_OneWeekData.verboseMessage + '<strong>\n                        </div>\n                    </li>');
        });
    }).fail(function (error) {
        alert(error);
    });
    _jquery2.default.getJSON(_config2.default.serverUrl + '/overdueMonitor/warning_TwoWeek').done(function (warning_TwoWeekDataList) {
        warning_TwoWeekDataList.forEach(function (warning_TwoWeekData) {
            (0, _jquery2.default)('ol#twoWeekWarningList').append('<li class="panel panel-info">\n                        <div class="panel-heading">\n                            <strong>' + warning_TwoWeekData.verboseMessage + '<strong>\n                        </div>\n                    </li>');
        });
    }).fail(function (error) {
        alert(error);
    });
    _jquery2.default.getJSON(_config2.default.serverUrl + '/overdueMonitor/warning_NewOverdue').done(function (warning_NewOverdueDataList) {
        warning_NewOverdueDataList.forEach(function (warning_NewOverdueData) {
            (0, _jquery2.default)('ol#newOverdueList').append('<li class="panel panel-danger">\n                        <div class="panel-heading">\n                            <strong>' + warning_NewOverdueData.verboseMessage + '<strong>\n                        </div>\n                    </li>');
        });
    }).fail(function (error) {
        alert(error);
    });
    _jquery2.default.getJSON(_config2.default.serverUrl + '/overdueMonitor/warning_PastWeekOverdue').done(function (warning_PastWeekOverdueDataList) {
        warning_PastWeekOverdueDataList.forEach(function (warning_PastWeekOverdueData) {
            (0, _jquery2.default)('ol#recentOverdueList').append('<li class="panel panel-warning">\n                        <div class="panel-heading">\n                            <strong>' + warning_PastWeekOverdueData.verboseMessage + '<strong>\n                        </div>\n                    </li>');
        });
    }).fail(function (error) {
        alert(error);
    });
    _jquery2.default.getJSON(_config2.default.serverUrl + '/overdueMonitor/warning_ProlongedOverdue').done(function (warning_ProlongedOverdueDataList) {
        warning_ProlongedOverdueDataList.forEach(function (warning_ProlongedOverdueData) {
            (0, _jquery2.default)('ol#prolongedOverdueList').append('<li class="panel panel-primary">\n                        <div class="panel-heading">\n                            <strong>' + warning_ProlongedOverdueData.verboseMessage + '<strong>\n                        </div>\n                    </li>');
        });
    }).fail(function (error) {
        alert(error);
    });
...
},{"./config.js":7,"jquery":1,"moment-timezone":3,"numeral":6}]},{},[8]);

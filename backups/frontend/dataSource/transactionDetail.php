<?php
    ...
    $queryString = "SELECT * FROM overdueMonitor.dbo.maintenance_transactionDetail WHERE CUS_NO='".$_GET['CUS_NO']."' AND AMTN_OUT>0 ORDER BY PS_DD;";
    ...
    try {
        ...
        die('客戶交易付款資料讀取發生錯誤...<br>'.$error->getMessage());
    }
?>
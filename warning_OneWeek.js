// this APP will query the UPGI_OverdueMonitor.dbo.warning_OneWeek and get records that will become overdue within this week, and write data to the server to cause a mobile broadcast to the user.  Intented to run every Monday morning at 08:55 (once a week)
...
mssql.connect(mssqlConfig, function (err) {
    ...
    request.query('SELECT * FROM UPGI_OverdueMonitor.dbo.warning_OneWeek;', function (err, resultset) {
        if (err) throw err;
